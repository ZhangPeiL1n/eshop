package com.zpl.eshop.customer;
...
public class ReturnGoodsWorksheetDAOTest {
    ...
    public void testSave() throws Exception {
        ...
        Assert.assertNotNull(worksheet.getId());
        Assert.assertThat(worksheet.getId(), Matchers.greaterThan(0L));
    }
    ...
    public void testGetById() throws Exception {
        ...
        Assert.assertEquals(expectedReturnGoodsWorksheet, actualReturnGoodsWorksheet);
    }
    ...
    private void compareReturnGoodsWorksheets(
        ...
        Assert.assertEquals((int) expectedSize, actualReturnGoodsWorksheets.size());
    ...
    private Map<Long, ReturnGoodsWorksheetDO> createReturnGoodsWorksheetMap(
        ...
        Map<Long, ReturnGoodsWorksheetDO> worksheetMap = new HashMap<>();
    ...
    private List<ReturnGoodsWorksheetDO> createReturnGoodsWorksheets(
            Integer count, Boolean includeRemark) throws Exception {
        List<ReturnGoodsWorksheetDO> worksheets = new ArrayList<>();
