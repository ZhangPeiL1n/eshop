...
public class GoodsDetailPictureDAOTest {
    ...
    public void testGetById() throws Exception {
        ...
        GoodsDetailPictureDO actualGoodsDetailPicture = goodsDetailPictureDAO.getById(expectedGoodsDetailPicture.getId());
    ...
    public void testListByGoodsDetailId() throws Exception {
        Long goodsDetailId = 1L;
        Integer count = 10;
        Map<Long, GoodsDetailPictureDO> expectedGoodsDetailPictureMap = createGoodsDetailPictureMap(goodsDetailId, count);

        List<GoodsDetailPictureDO> actualGoodsDetailPictures = goodsDetailPictureDAO.listByGoodsDetailId(goodsDetailId);

        compareGoodsDetailPictures(count, expectedGoodsDetailPictureMap, actualGoodsDetailPictures);
    }
     ...
     * @throws Exception
     */
    private void compareGoodsDetailPictures(Integer expectedSize, Map<Long, GoodsDetailPictureDO> expectedGoodsDetailPictureMap, List<GoodsDetailPictureDO> actualGoodsDetailPictures) throws Exception {
        ...
        for (GoodsDetailPictureDO actualGoodsDetailPicture : actualGoodsDetailPictures) {
            GoodsDetailPictureDO expectedGoodsDetailPicture = expectedGoodsDetailPictureMap.get(actualGoodsDetailPicture.getId());
            assertEquals(expectedGoodsDetailPicture, actualGoodsDetailPicture);
        }
    }
     ...
     * @throws Exception
     */
    private Map<Long, GoodsDetailPictureDO> createGoodsDetailPictureMap(Long goodsDetailId, Integer count) throws Exception {
        Map<Long, GoodsDetailPictureDO> goodsDetailPictureMap = new HashMap<>();

        List<GoodsDetailPictureDO> goodsDetailPictures = createGoodsDetailPictures(goodsDetailId, count);
     ...
     * @throws Exception
     */
    private List<GoodsDetailPictureDO> createGoodsDetailPictures(Long goodsDetailId, Integer count) throws Exception {
        List<GoodsDetailPictureDO> goodsDetailPictures = new ArrayList<>();
