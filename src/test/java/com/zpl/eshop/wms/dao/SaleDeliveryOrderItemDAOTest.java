...
public class SaleDeliveryOrderItemDAOTest {
    ...
    public void testSave() throws Exception {
        ...
        Assert.assertNotNull(saleDeliveryOrderItem.getId());
        Assert.assertThat(saleDeliveryOrderItem.getId(), Matchers.greaterThan(0L));
    }
     ...
     * 比较销售出库单集合
     *
     * @param expectedSaleDeliveryOrderItemMap 期望的销售出库单集合
     * @param actualSaleDeliveryOrderItems     实际的销售出库单集合
     * @throws Exception
     */
    private void compareSaleDeliveryOrderItems(Integer expectedSize,
        ...
        Assert.assertEquals((int) expectedSize, actualSaleDeliveryOrderItems.size());
        ...
        for (SaleDeliveryOrderItemDO actualSaleDeliveryOrderItem : actualSaleDeliveryOrderItems) {
            ...
            Assert.assertEquals(expectedSaleDeliveryOrderItem, actualSaleDeliveryOrderItem);
        }
    }
