...
public class SaleDeliveryOrderDAOTest {
    ...
    public void testSave() throws Exception {
        ...
        Assert.assertNotNull(saleDeliveryOrder.getId());
        Assert.assertThat(saleDeliveryOrder.getId(), Matchers.greaterThan(0L));
    }
    ...
    public void testGetById() throws Exception {
        ...
        Assert.assertEquals(expectedSaleDeliveryOrder, actualSaleDeliveryOrder);
    }
    ...
    private void compareSaleDeliveryOrders(Integer expectedSize,
        ...
        Assert.assertEquals((int) expectedSize, actualSaleDeliveryOrders.size());
    ...
    private SaleDeliveryOrderDO createSaleDeliveryOrder(
