...
public class SendOutOrderItemDAOTest {
    ...
    public void testSave() throws Exception {
        ...
        Assert.assertNotNull(sendOutOrderItem.getId());
        Assert.assertThat(sendOutOrderItem.getId(), Matchers.greaterThan(0L));
    }
    ...
    private void compareSendOutOrderItems(Integer expectedSize,
        ...
        Assert.assertEquals((int) expectedSize, actualSendOutOrderItems.size());
        ...
        for (SendOutOrderItemDO actualSendOutOrderItem : actualSendOutOrderItems) {
            ...
            Assert.assertEquals(expectedSendOutOrderItem, actualSendOutOrderItem);
        }
    }
    ...
    private Map<Long, SendOutOrderItemDO> createSendOutOrderItemMap(Integer count,
        ...
        Map<Long, SendOutOrderItemDO> sendOutOrderItemMap = new HashMap<>();
    ...
    private List<SendOutOrderItemDO> createSendOutOrderItems(Integer count, Long sendOutOrderId) throws Exception {
        List<SendOutOrderItemDO> sendOutOrderItems = new ArrayList<>();
