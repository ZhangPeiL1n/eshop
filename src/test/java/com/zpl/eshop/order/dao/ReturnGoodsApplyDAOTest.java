...
public class ReturnGoodsApplyDAOTest {
    ...
    public void testSave() throws Exception {
        ...
        Assert.assertNotNull(returnGoodsApply.getId());
        Assert.assertThat(returnGoodsApply.getId(), Matchers.greaterThan(0L));
    }
    ...
    public void testGetByOrderInfoId() throws Exception {
        ...
        Assert.assertEquals(expectedReturnGoodsApply, actualReturnGoodsApply);
    }
