...
public class OrderOperateLogDAOTest {
    ...
    public void testListByOrderInfoId() throws Exception {
        Integer count = 10;
        Long orderInfoId = 1L;
        Map<Long, OrderOperateLogDO> expectedOrderOperateLogMap = createOrderOperateLogMap(count, orderInfoId);

        List<OrderOperateLogDO> actualOrderOperateLogs = orderOperateLogDAO.listByOrderInfoId(orderInfoId);
     ...
     * 比较订单集合
     *
     * @param expectedOrderOperateLogMap 期望的订单集合
     * @param actualOrderOperateLogs     实际的订单集合
     * @throws Exception
     */
    private void compareOrderOperateLogs(Integer expectedSize, Map<Long, OrderOperateLogDO> expectedOrderOperateLogMap, List<OrderOperateLogDO> actualOrderOperateLogs) throws Exception {
