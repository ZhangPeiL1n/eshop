...
public class ScheduleGoodsStockDAOTest {
    ...
    public void testSave() throws Exception {
        ...
        Assert.assertNotNull(expectedGoodsStock.getId());
        Assert.assertThat(expectedGoodsStock.getId(), Matchers.greaterThan(0L));
    }
    ...
    public void testGetBySkuId() throws Exception {
        ...
        Assert.assertEquals(expectedGoodsStock, actualGoodsStock);
    }
