...
public class ScheduleGoodsAllocationStockDAOTest {
    ...
    public void testSave() throws Exception {
        ...
        Assert.assertNotNull(expectedGoodsAllocationStock.getId());
        Assert.assertThat(expectedGoodsAllocationStock.getId(), Matchers.greaterThan(0L));
    }
    ...
    public void testGetBySkuId() throws Exception {
        ...
        Assert.assertEquals(expectedGoodsAllocationStock, actualGoodsAllocationStock);
    }
