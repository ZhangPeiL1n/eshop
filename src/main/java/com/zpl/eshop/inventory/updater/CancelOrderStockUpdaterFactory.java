 ...
 **/
@Component
public class CancelOrderStockUpdaterFactory extends AbstractStockUpdaterFactory<OrderInfoDTO> {
    /**
     * 构造函数
     *
    ...
    protected StockUpdater create(List<GoodsStockDO> goodsStockDOList, OrderInfoDTO parameter) throws Exception {
        ...
        return new CancelOrderStockUpdater(goodsStockDOList, goodsStockDAO, dateProvider, orderItemDTOMap);
    }
