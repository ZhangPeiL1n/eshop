...
public interface CouponAchieveMapper {
    ...
    CouponAchieveDO getByUserAccountId(@Param("couponId") Long couponId, @Param("userAccountId") Long userAccountId);
    ...
    List<CouponAchieveDO> listUnusedByUserAccountId(@Param("userAccountId") Long userAccountId);
