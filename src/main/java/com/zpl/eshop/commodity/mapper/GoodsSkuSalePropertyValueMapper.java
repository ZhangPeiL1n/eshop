...
public interface GoodsSkuSalePropertyValueMapper {
    ...
    List<GoodsSkuSalePropertyValueDO> listByGoodsSkuId(@Param("goodsSkuId") Long goodsSkuId);
     ...
     * @param goodsSkuId 商品sku id
     */
    @Delete("DELETE FROM commodity_goods_sku_sale_property_value WHERE goods_sku_id=#{goodsSkuId}")
